...
export default class GameOver extends IState {
    gameover:any;
    counter:number = 255;   
    constructor(){
        super();
    ...
    public init(){
        return Promise.all([
            (new Promise((resolve, reject)=>{
                ...
                this.gameover.src = 'assets/images/gameover.png';
    ...
    public render(){
        ...
        let x = (StateMachine.canvas.width / 2) - ( this.gameover.width / 2);
        let y = (StateMachine.canvas.height / 2) - ( this.gameover.height / 2);
        ...
        ctx.drawImage(this.gameover, 0, 0, this.gameover.width, this.gameover.height, x, y, this.gameover.width, this.gameover.height);
